def Almacen(cant_ecuaciones, problema, signos, vector_x, vector_y, vector_r, X_Intro, Y_Intro, Sig_x, Sig_y):    
    cant_variables = 2
                ...
                if flagss == 1:
                    ...
                    while s <= (cant_variables + cant_ecuacionesH + 2):
                        if s <= (cant_variables + 1):
                            variables[r2].append(float(vector_x[r-1]))
                            variables[r2].append(float(vector_y[r-1]))
